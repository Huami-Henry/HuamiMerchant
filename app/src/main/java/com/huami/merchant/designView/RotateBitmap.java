...
public class RotateBitmap {
    ...
    public int getHeight() {
        return this.bitmap == null?0:(this.isOrientationChanged()?this.bitmap.getWidth():this.bitmap.getHeight());
    }

    public int getWidth() {
        return this.bitmap == null?0:(this.isOrientationChanged()?this.bitmap.getHeight():this.bitmap.getWidth());
    }
