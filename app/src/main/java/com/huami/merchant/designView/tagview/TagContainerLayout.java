package com.huami.merchant.designView.tagview;
...
public class TagContainerLayout extends ViewGroup{
     ...
     */
    private float mBorderRadius = 1.0f;
     ...
     */
    private float mTagBorderRadius = 13.0f;
     ...
     */
    private int mTagVerticalPadding = 4;
     ...
     */
    private int mTagBackgroundColor = Color.parseColor("#AAEBEBEB");

    /**
     * TagView text color(default #FF666666)
     */
    private int mTagTextColor = Color.parseColor("#aa222222");
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mVerticalInterval = (int) attributes.getDimension(R.styleable.AndroidTagView_vertical_interval,
                DisplayUtil.dp2px(context, DEFAULT_INTERVAL));
        ...
        mTagBorderWidth = attributes.getDimension(R.styleable.AndroidTagView_tag_border_width,
                DisplayUtil.dp2px(context, mTagBorderWidth));
        mTagBorderRadius = attributes.getDimension(
                R.styleable.AndroidTagView_tag_corner_radius, DisplayUtil.dp2px(context, mTagBorderRadius));
        mTagHorizontalPadding = (int) attributes.getDimension(
                R.styleable.AndroidTagView_tag_horizontal_padding,
                DisplayUtil.dp2px(context, mTagHorizontalPadding));
        mTagVerticalPadding = (int) attributes.getDimension(
                R.styleable.AndroidTagView_tag_vertical_padding, DisplayUtil.dp2px(context, mTagVerticalPadding));
        mTagTextSize = attributes.getDimension(R.styleable.AndroidTagView_tag_text_size,
                DisplayUtil.dp2px(context, mTagTextSize));
        ...
        mCrossLineWidth = attributes.getDimension(R.styleable.AndroidTagView_tag_cross_line_width,
                DisplayUtil.dp2px(context, mCrossLineWidth));
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    public void setTagBdDistance(float tagBdDistance) {
        this.mTagBdDistance = DisplayUtil.dp2px(getContext(), tagBdDistance);
    }
    ...
    /**
     * Inserts the specified TagccView into this ContainerLayout at the end.
     *
     * @param text
     */
    ...
    public void setVerticalInterval(float interval) {
        mVerticalInterval = DisplayUtil.dp2px(getContext(), interval);
        postInvalidate();
    }
    ...
    public void setHorizontalInterval(float interval) {
        mHorizontalInterval = DisplayUtil.dp2px(getContext(), interval);
        postInvalidate();
    }
