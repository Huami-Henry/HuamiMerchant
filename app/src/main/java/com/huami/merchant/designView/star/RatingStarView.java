package com.huami.merchant.designView.star;
...
public class RatingStarView extends View implements View.OnClickListener {
    ...
    private int starBackgroundColor = 0x00000000;
    ...
    private void loadAttributes(AttributeSet attrs, int defStyle) {
        ...
        strokeColor = a.getColor(R.styleable.RatingStarView_rat_strokeColor, strokeColor);
