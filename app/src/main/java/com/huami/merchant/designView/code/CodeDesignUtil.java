package com.huami.merchant.designView.code;
...
public class CodeDesignUtil {
    private static final char[] CHARS = {
            '2', '3', '4', '5', '6', '7', '8', '9',
            'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'l', 'm',
            'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'};

    private static CodeDesignUtil bmpCode;

    public static CodeDesignUtil getInstance() {
        if(bmpCode == null)
            bmpCode = new CodeDesignUtil();
        return bmpCode;
    }
