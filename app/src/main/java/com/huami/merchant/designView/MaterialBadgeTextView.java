...
public class MaterialBadgeTextView extends AppCompatTextView {
    ...
    private void refreshBackgroundDrawable(int targetWidth, int targetHeight) {
        Log.e("我的方法", "refreshBackgroundDrawable()");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float fx=getWidth()/2.0f;
        float fy = getHeight() / 2.0f;
        canvas.drawCircle(fx, fy, fx-5, paint);
    }
    ...
    class SemiCircleRectDrawable extends Drawable {
        ...
        public SemiCircleRectDrawable() {
            Log.e("我的方法", "SemiCircleRectDrawable--->SemiCircleRectDrawable()");
            mPaint = new Paint();
        ...
        public void setBounds(int left, int top, int right, int bottom) {
            ...
            Log.e("我的方法", "SemiCircleRectDrawable--->setBounds()");
            if (rectF == null) {
        ...
        public void draw(Canvas canvas) {
            Log.e("我的方法", "SemiCircleRectDrawable--->draw()");
