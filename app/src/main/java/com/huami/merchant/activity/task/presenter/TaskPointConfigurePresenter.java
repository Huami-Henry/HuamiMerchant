...
import com.huami.merchant.activity.task.TaskPointConfigureActivity;
...
public class TaskPointConfigurePresenter extends BasePresenter<TaskPointConfigureActivity,TaskPointModelImp> {
