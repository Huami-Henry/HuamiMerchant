...
public class SPCache {
    ...
    private String mPrefFileName = "com.mystery";
     ...
     * 清除用户中心数据
     */
    public static void _removePersonDetail(){
        SPCache.remove(BaseConsts.USER_CENTER.USER_TOKEN);
        SPCache.remove(BaseConsts.USER_CENTER.USER_ID);
        BaseApplication.UUID = null;
        BaseApplication.UU_TOKEN = null;
    }
    //clear
